...
<html lang="en" class="app">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/bgcss.css" type="text/css" />
        <!--[if lt IE 9]>
                ...
                <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="thumb-sm avatar pull-left"> <img src="images/a0.png" alt="..." /> </span> <?php echo $_SESSION['uname'] ?> <b class="caret"></b>
                        </a>
